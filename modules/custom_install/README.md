 ...
 * This module provides example to write custom install file with some example hooks. Compatible with Drupal 8, 9 and 10.
 ...
 * To enable the module go to Administer > Modules, and enable "Custom Install".

 * After installation you will see a new table is created in your database named "custom_install_example".
