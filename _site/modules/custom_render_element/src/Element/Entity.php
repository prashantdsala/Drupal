...
namespace Drupal\custom_render_element\Element;
...
class Entity extends RenderElement {
  ...
  public static function preRenderEntityElement(array $element) {
    ...
    // Load the entity provided in the element.
    $entity = $entity_type_manager
      ->getStorage($element['#entity_type'])
      ->load($element['#entity_id']);

    if ($entity && $entity->access('view')) {
      // Render entity with entity view builder see core/lib/Drupal/Core/Entity/EntityTypeManager.php.
